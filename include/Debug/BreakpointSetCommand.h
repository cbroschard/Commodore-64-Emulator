...
#ifndef BREAKPOINTSETCOMMAND_H
#define BREAKPOINTSETCOMMAND_H
...
class BreakpointSetCommand : public MonitorCommand
{
    public:
        BreakpointSetCommand();
        virtual ~BreakpointSetCommand();
