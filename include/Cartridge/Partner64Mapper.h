...
#ifndef PARTNER64MAPPER_H
#define PARTNER64MAPPER_H

#include "Cartridge/CartridgeMapper.h"
#include "Cartridge/IHasButton.h"

class Partner64Mapper : public CartridgeMapper, public IHasButton
{
    public:
        Partner64Mapper();
        virtual ~Partner64Mapper();
