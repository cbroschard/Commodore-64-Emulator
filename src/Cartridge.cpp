...
bool Cartridge::loadROM(const std::string& path)
{
    ...
    switch(mapperType)
    {
        ...
        case CartridgeType::UNIVERSAL_CARTRIDGE_15:
            configureRAM(32768);
            break;
        case CartridgeType::UNIVERSAL_CARTRIDGE_2:
            configureRAM(512 * 1024);
            break;
        default:
            break;
    }
...
Cartridge::CartridgeType Cartridge::detectType(uint16_t type)
{
    switch (type)
    {
        ...
        case 0x2C:  return CartridgeType::EXOS;
        ...
        case 0x52:  return CartridgeType::UNIVERSAL_CARTRIDGE_2;
...
std::string Cartridge::getMapperName() const
{
    switch (mapperType)
    {
        ...
        case CartridgeType::UNIVERSAL_CARTRIDGE_15: return "Universal Cartridge 1.5";
        case CartridgeType::UNIVERSAL_CARTRIDGE_2:  return "Universal Cartridge 2";
...
std::unique_ptr<CartridgeMapper> Cartridge::createMapper(CartridgeType t)
{
    switch (t)
    {
        ...
        case CartridgeType::EXOS:                   return std::make_unique<EXOSMapper>();
        ...
        case CartridgeType::UNIVERSAL_CARTRIDGE_2: return std::make_unique<UniversalCartridge2Mapper>();
