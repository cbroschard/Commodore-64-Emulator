...
namespace
{
   const std::array<SDL_Color, 16> NTSC_COLORS =
    {{
        ...
        {0x88, 0x40, 0x00, 0xFF}, // $2 Red
        {0x68, 0xD0, 0xA8, 0xFF}, // $3 Cyan

        {0xA8, 0x38, 0xA0, 0xFF}, // $4 Purple
        {0x50, 0xB8, 0x18, 0xFF}, // $5 Green

        {0x18, 0x10, 0x90, 0xFF}, // $6 Blue
        {0xF0, 0xE8, 0x58, 0xFF}, // $7 Yellow

        {0xA0, 0x48, 0x00, 0xFF}, // $8 Orange
        {0x47, 0x2B, 0x1B, 0xFF}, // $9 Brown

        {0xC8, 0x78, 0x70, 0xFF}, // $A Light Red
        {0x48, 0x48, 0x48, 0xFF}, // $B Dark Gray

        {0x80, 0x80, 0x80, 0xFF}, // $C Gray
        {0x98, 0xFF, 0x98, 0xFF}, // $D Light Green

        {0x50, 0x90, 0xD0, 0xFF}, // $E Light Blue
        {0xB8, 0xB8, 0xB8, 0xFF}  // $F Light Gray
    }};
