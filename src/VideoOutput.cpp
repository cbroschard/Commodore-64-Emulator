...
{{
    ...
    {0xAF, 0x2A, 0x29, 0xFF}, // $2 Red
    {0x6E, 0xD8, 0xCC, 0xFF}, // $3 Cyan

    {0xB0, 0x3F, 0xB6, 0xFF}, // $4 Purple
    {0x4A, 0xC6, 0x4A, 0xFF}, // $5 Green

    {0x37, 0x39, 0xC4, 0xFF}, // $6 Blue
    {0xE4, 0xED, 0x4E, 0xFF}, // $7 Yellow

    {0xB6, 0x59, 0x1C, 0xFF}, // $8 Orange
    {0x68, 0x38, 0x08, 0xFF}, // $9 Brown

    {0xEA, 0x74, 0x6C, 0xFF}, // $A Light Red
    {0x4D, 0x4D, 0x4D, 0xFF}, // $B Dark Gray

    {0x84, 0x84, 0x84, 0xFF}, // $C Gray
    {0xA6, 0xFA, 0x9E, 0xFF}, // $D Light Green

    {0x70, 0x7C, 0xE6, 0xFF}, // $E Light Blue
    {0xB6, 0xB6, 0xB5, 0xFF}  // $F Light Gray
}};
