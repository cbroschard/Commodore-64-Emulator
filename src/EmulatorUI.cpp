...
void EmulatorUI::installMenu(const MediaViewState& v)
{
    ...
    if (ImGui::BeginMainMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Peripheral"))
        {
            ...
            {
                const bool reuAvailable =
                    !v.virtualModemAttached &&
                    !v.swiftLinkEnabled &&
                    !v.turbo232Enabled;
